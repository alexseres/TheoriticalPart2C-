...
namespace Tutorial15LinqTutorial
{
    class Program
    {
        ...
        public static void QueryCollection()
        {
            ...
            {
                Console.WriteLine("{0} weighs {1}",dog.Name, dog.Weight);
            }
        }
        ...
        static void QueryAnimalData()
        {
            ...
            var nameHeights = from a in animals
                select new
                {
                    a.Name,
                    a.Height
                };
            Array arrayNameHeight = nameHeights.ToArray();
